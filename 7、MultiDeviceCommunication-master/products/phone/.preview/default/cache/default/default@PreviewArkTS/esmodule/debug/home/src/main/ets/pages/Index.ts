...
export class Index extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/home/src/main/ets/pages/Index.ets(68:5)", "home");
            Column.height('100%');
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
             ...
             */
            Flex.create();
            Flex.debugLine("features/home/src/main/ets/pages/Index.ets(72:7)", "home");
            /**
             * Home and contacts page
             */
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("features/home/src/main/ets/pages/Index.ets(83:9)", "home");
            // [Start nav_path_stack]
            ...
            if (this.currentPageIndex === 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Flex.debugLine("features/home/src/main/ets/pages/Index.ets(85:13)", "home");
                        Flex.padding({
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Flex.create({ direction: FlexDirection.Column, justifyContent: FlexAlign.Center });
                        Flex.debugLine("features/home/src/main/ets/pages/Index.ets(102:13)", "home");
                        Flex.height('100%');
                        Flex.padding({
                            bottom: deviceInfo.deviceType !== '2in1' && this.currentBreakpoint !== 'lg' ? '28vp' : '0vp'
                        });
                ...
                this.ifElseBranchUpdateFunction(2, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Flex.create({ direction: FlexDirection.Column, justifyContent: FlexAlign.Center });
                        Flex.debugLine("features/home/src/main/ets/pages/Index.ets(120:13)", "home");
                        Flex.height('100%');
                        Flex.padding({
                            bottom: deviceInfo.deviceType !== '2in1' && this.currentBreakpoint !== 'lg' ? '28vp' : '0vp'
                        });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("features/home/src/main/ets/pages/Index.ets(149:7)", "home");
            // [StartExclude navigation_diff_device]
            /**
             * SocialCircle page
             */
             ...
             */
            Flex.padding({
                bottom: { "id": 50331853, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" }
            });
        }, Flex);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            __Common__.create();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("features/home/src/main/ets/pages/Index.ets(165:7)", "home");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            __Common__.create();
            __Common__.width(Adaptive.HomeTabWidth(this.currentBreakpoint));
            __Common__.backgroundColor({ "id": 50331666, "type": 10001, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" });
            __Common__.padding({
                top: { "id": 50331820, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" },
                bottom: { "id": 50331818, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" },
                left: { "id": 50331819, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" }
            });
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
             ...
             */
            Flex.create({ direction: FlexDirection.Column });
            Flex.debugLine("features/home/src/main/ets/pages/Index.ets(184:7)", "home");
            /**
             * Me page
             */
            Flex.width('100%');
             ...
             */
            Flex.padding({
                top: deviceInfo.deviceType === '2in1' ? { "id": 50331860, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" } : { "id": 50331797, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" },
                bottom: deviceInfo.deviceType !== '2in1'
                    && this.currentBreakpoint !== 'lg' ? { "id": 50331853, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" } : { "id": 50331860, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" }
            });
        }, Flex);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/home/src/main/ets/pages/Index.ets(185:9)", "home");
            Column.flexGrow(1);
        }, Column);
        Column.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("features/home/src/main/ets/pages/Index.ets(203:7)", "home");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/home/src/main/ets/pages/Index.ets(212:9)", "home");
