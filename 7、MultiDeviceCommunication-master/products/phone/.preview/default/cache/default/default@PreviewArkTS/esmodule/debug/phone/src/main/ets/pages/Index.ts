...
class Index extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            GridRow.debugLine("products/phone/src/main/ets/pages/Index.ets(25:5)", "phone");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            GridCol.debugLine("products/phone/src/main/ets/pages/Index.ets(32:7)", "phone");
            GridCol.height(BaseConstants.FULL_PERCENT);
            GridCol.width(BaseConstants.FULL_PERCENT);
        }, GridCol);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("products/phone/src/main/ets/pages/Index.ets(37:9)", "phone");
