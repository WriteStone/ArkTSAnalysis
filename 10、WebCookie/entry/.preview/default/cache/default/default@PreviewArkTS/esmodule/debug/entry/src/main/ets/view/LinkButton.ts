    ...
    operationMethod(): void {
        try {
            if (this.buttonType === CommonConstants.CookieOperation[0]) {
                ...
                showDialog({ "id": 16777235, "type": 10003, params: [], "bundleName": "com.example.webcookie", "moduleName": "entry" });
            }
            else if (this.buttonType === CommonConstants.CookieOperation[2]) {
                webview.WebCookieManager.clearAllCookiesSync();
                let deleteMessage = { "id": 16777223, "type": 10003, params: [], "bundleName": "com.example.webcookie", "moduleName": "entry" };
