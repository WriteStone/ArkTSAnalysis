...
export class CommonConstants {
     ...
     */
    static readonly CookieOperation: string[] = [
        getContext(this).resourceManager.getStringSync({ "id": 16777224, "type": 10003, params: [], "bundleName": "com.example.webcookie", "moduleName": "entry" }.id),
        getContext(this).resourceManager.getStringSync({ "id": 16777229, "type": 10003, params: [], "bundleName": "com.example.webcookie", "moduleName": "entry" }.id),
        getContext(this).resourceManager.getStringSync({ "id": 16777221, "type": 10003, params: [], "bundleName": "com.example.webcookie", "moduleName": "entry" }.id),
        getContext(this).resourceManager.getStringSync({ "id": 16777232, "type": 10003, params: [], "bundleName": "com.example.webcookie", "moduleName": "entry" }.id)
    ];
}
