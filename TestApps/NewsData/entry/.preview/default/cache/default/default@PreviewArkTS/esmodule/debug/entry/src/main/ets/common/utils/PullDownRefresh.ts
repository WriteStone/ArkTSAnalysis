...
export function pullRefreshState(that: NewsModel, state: number) {
    switch (state) {
        ...
        case 1:
            ...
            that.pullDownRefreshImage = { "id": 16777219, "type": 20000, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
        ...
        case 2:
            ...
            that.pullDownRefreshImage = { "id": 16777233, "type": 20000, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            that.isCanRefresh = true;
