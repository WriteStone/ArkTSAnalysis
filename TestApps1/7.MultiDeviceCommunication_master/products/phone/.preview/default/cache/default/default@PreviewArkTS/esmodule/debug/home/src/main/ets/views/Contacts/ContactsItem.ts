...
export class ContactsItem extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("features/home/src/main/ets/views/Contacts/ContactsItem.ets(25:5)", "home");
            Flex.height(BaseConstants.FULL_HEIGHT);
            Flex.width(BaseConstants.FULL_WIDTH);
        }, Flex);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/home/src/main/ets/views/Contacts/ContactsItem.ets(26:7)", "home");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("features/home/src/main/ets/views/Contacts/ContactsItem.ets(27:9)", "home");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/home/src/main/ets/views/Contacts/ContactsItem.ets(34:7)", "home");
            Column.flexShrink(BaseConstants.FLEX_SHRINK_ONE);
            Column.margin({ left: { "id": 50331691, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" } });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.name);
            Text.debugLine("features/home/src/main/ets/views/Contacts/ContactsItem.ets(35:9)", "home");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("features/home/src/main/ets/views/Contacts/ContactsItem.ets(44:7)", "home");
        }, Blank);
        Blank.pop();
        Flex.pop();
    }
