        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Flex.debugLine("features/home/src/main/ets/views/Conversation/ConversationDetailNone.ets(23:7)", "home");
                    Flex.backgroundColor({ "id": 50331882, "type": 10001, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" });
                    Flex.height(BaseConstants.FULL_HEIGHT);
                }, Flex);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Image.create({ "id": 50331757, "type": 20000, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" });
                    Image.debugLine("features/home/src/main/ets/views/Conversation/ConversationDetailNone.ets(24:9)", "home");
                    Image.width({ "id": 50331796, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" });
                    Image.height({ "id": 50331795, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" });
                }, Image);
                Flex.pop();
            ...
            NavDestination.debugLine("features/home/src/main/ets/views/Conversation/ConversationDetailNone.ets(22:5)", "home");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
