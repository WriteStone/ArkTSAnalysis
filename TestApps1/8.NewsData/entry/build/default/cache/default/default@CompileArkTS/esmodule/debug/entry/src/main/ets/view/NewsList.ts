...
export default class NewsList extends ViewPU {
    ...
    ListLayout(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.backgroundColor({ "id": 16777242, "type": 10001, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" });
            List.divider({
                color: { "id": 16777237, "type": 10001, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" },
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        // Pull-down refresh layout
                        ListItem.backgroundColor({ "id": 16777244, "type": 10001, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" });
                        // Pull-down refresh layout
