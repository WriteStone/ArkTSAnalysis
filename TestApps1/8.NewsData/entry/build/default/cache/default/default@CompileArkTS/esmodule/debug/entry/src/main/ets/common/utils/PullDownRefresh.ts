...
export function pullRefreshState(that: NewsModel, state: number) {
    switch (state) {
        case 0:
            that.pullDownRefreshText = { "id": 16777226, "type": 10003, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            that.pullDownRefreshImage = { "id": 16777246, "type": 20000, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            that.isCanRefresh = false;
            that.isRefreshing = false;
            that.isVisiblePullDown = true;
            break;
        case 1:
            that.pullDownRefreshText = { "id": 16777233, "type": 10003, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
        ...
        case 2:
            ...
            that.pullDownRefreshImage = { "id": 16777247, "type": 20000, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            that.isCanRefresh = true;
        ...
        case 4:
            ...
            that.pullDownRefreshImage = { "id": 16777245, "type": 20000, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            that.isCanRefresh = true;
            that.isRefreshing = true;
            break;
        default:
