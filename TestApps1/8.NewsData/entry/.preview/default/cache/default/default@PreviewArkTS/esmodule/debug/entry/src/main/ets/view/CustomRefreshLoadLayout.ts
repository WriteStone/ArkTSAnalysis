...
export default class CustomLayout extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/view/CustomRefreshLoadLayout.ets(29:7)", "entry");
            // Image of pull-down refresh
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/CustomRefreshLoadLayout.ets(34:7)", "entry");
            // Text of pull-down refresh
            Text.margin({
