...
export class SocialCircle extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("features/socialCircle/src/main/ets/pages/Index.ets(44:5)", "socialcircle");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create();
            List.debugLine("features/socialCircle/src/main/ets/pages/Index.ets(45:7)", "socialcircle");
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ListItem.create(deepRenderFunction, true);
                        ListItem.debugLine("features/socialCircle/src/main/ets/pages/Index.ets(47:11)", "socialcircle");
                    };
    ...
    CircleItem(pictureArray: PictureArrayInterface, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Flex.create();
            Flex.debugLine("features/socialCircle/src/main/ets/pages/Index.ets(65:5)", "socialcircle");
            Flex.padding({
                left: { "id": 50331811, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" },
                right: { "id": 50331812, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" },
                top: { "id": 50331813, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" },
                bottom: { "id": 50331810, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" }
            });
            Flex.width(BaseConstants.FULL_WIDTH);
        }, Flex);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 50331718, "type": 20000, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" });
            Image.debugLine("features/socialCircle/src/main/ets/pages/Index.ets(66:7)", "socialcircle");
            ...
            Image.margin({ right: { "id": 50331824, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" } });
            Image.borderRadius(PictureConstants.ICON_BORDER_RADIUS);
            Image.objectFit(ImageFit.Auto);
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/socialCircle/src/main/ets/pages/Index.ets(72:7)", "socialcircle");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("features/socialCircle/src/main/ets/pages/Index.ets(73:9)", "socialcircle");
            ...
            Text.margin({ bottom: { "id": 50331859, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" } });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(PictureConstants.USER_MESSAGE);
            Text.debugLine("features/socialCircle/src/main/ets/pages/Index.ets(79:9)", "socialcircle");
            ...
            Text.margin({ bottom: { "id": 50331858, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" } });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Grid.create();
            Grid.debugLine("features/socialCircle/src/main/ets/pages/Index.ets(86:9)", "socialcircle");
            ...
            Grid.columnsGap({ "id": 50331850, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" });
            Grid.rowsGap({ "id": 50331850, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" });
            ...
            const forEachItemGenFunction = _item => {
                const picture = _item;
                {
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        GridItem.debugLine("features/socialCircle/src/main/ets/pages/Index.ets(88:13)", "socialcircle");
                    };
                    const observedDeepRender = () => {
                        this.observeComponentCreation2(itemCreation2, GridItem);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Image.create(picture.src);
                            Image.debugLine("features/socialCircle/src/main/ets/pages/Index.ets(89:15)", "socialcircle");
