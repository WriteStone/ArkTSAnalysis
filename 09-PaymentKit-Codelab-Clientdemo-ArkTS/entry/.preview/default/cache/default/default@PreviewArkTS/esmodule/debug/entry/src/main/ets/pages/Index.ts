...
class Index extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Index.ets(281:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.showDialog) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/Index.ets(284:9)", "entry");
                        Column.width('80%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/Index.ets(285:11)", "entry");
                        Text.fontSize(20);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/pages/Index.ets(294:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/Index.ets(309:7)", "entry");
            Button.type(ButtonType.Capsule);
            Button.width('50%');
            Button.margin(10);
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/Index.ets(316:7)", "entry");
            Button.type(ButtonType.Capsule);
            Button.width('50%');
            Button.margin(10);
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/Index.ets(323:7)", "entry");
            Button.type(ButtonType.Capsule);
            Button.width('50%');
            Button.margin(10);
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/Index.ets(331:7)", "entry");
            Button.type(ButtonType.Capsule);
            Button.width('50%');
            Button.margin(10);
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/Index.ets(338:7)", "entry");
            Button.type(ButtonType.Capsule);
            Button.width('50%');
            Button.margin(10);
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/Index.ets(345:7)", "entry");
            Button.type(ButtonType.Capsule);
            Button.width('50%');
            Button.margin(10);
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/Index.ets(352:7)", "entry");
            Button.type(ButtonType.Capsule);
            Button.width('50%');
            Button.margin(10);
            Button.onClick(() => {
