...
class PermissionDemo extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Scroll.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(225:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(226:7)", "entry");
            Column.width('100%');
            Column.padding({ left: 16, right: 16 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('返回', { type: ButtonType.Capsule, stateEffect: true });
            Button.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(227:9)", "entry");
            Button.width('90%');
            Button.height(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('通话记录权限');
            Text.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(235:9)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(236:9)", "entry");
            Button.width('90%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(239:9)", "entry");
            Button.width('90%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(242:9)", "entry");
            Button.width('90%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('短信权限');
            Text.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(246:9)", "entry");
            Text.fontSize(18);
            Text.margin({ top: 20, bottom: 10 });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(247:9)", "entry");
            Button.width('90%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(250:9)", "entry");
            Button.width('90%');
