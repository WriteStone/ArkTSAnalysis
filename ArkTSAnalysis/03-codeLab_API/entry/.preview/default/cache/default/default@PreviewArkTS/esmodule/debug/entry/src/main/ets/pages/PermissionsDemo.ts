...
class PermissionsDemo extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(21:5)", "entry");
            Column.width('100%');
            Column.height('100%');
            Column.padding(20);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(22:7)", "entry");
            Text.fontSize(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(27:7)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(37:7)", "entry");
            Scroll.width('100%');
            Scroll.height('70%');
        }, Scroll);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(38:9)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 文件选择部分
            Text.create('File Operations');
            Text.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(40:11)", "entry");
            // 文件选择部分
            Text.fontSize(20);
            // 文件选择部分
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(45:11)", "entry");
            Button.width('80%');
            ...
            if (this.selectedFilePath) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(52:13)", "entry");
                        Text.fontSize(16);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(56:13)", "entry");
                        Text.fontSize(16);
                        Text.margin({ bottom: 20 });
                    }, Text);
                    Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(62:11)", "entry");
            // Contacts APIs
            Text.fontSize(20);
            // Contacts APIs
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(67:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
        ...
        Button.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('Get Contacts (DataShare2)');
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(72:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
            Button.onClick(() => this.getContactsViaDataShare2());
        }, Button);
        Button.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('Get Contacts (queryContact)');
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(77:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(82:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(87:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(92:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(97:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(103:11)", "entry");
            // Call Log APIs
            Text.fontSize(20);
            // Call Log APIs
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(108:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(114:11)", "entry");
            // SMS APIs
            Text.fontSize(20);
            // SMS APIs
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(119:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(124:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(130:11)", "entry");
            // MMS APIs
            Text.fontSize(20);
            // MMS APIs
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(135:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(141:11)", "entry");
            // Calendar APIs
            Text.fontSize(20);
            // Calendar APIs
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(146:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(151:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionsDemo.ets(156:11)", "entry");
            Button.width('80%');
            Button.margin({ bottom: 10 });
    ...
    private getContactsViaDataShare2() {
        this.resultText = `API: dataShare.createDataShareHelper(context, 'datashare:///com.ohos.contactsdataability')\n` +
            `Permission: ohos.permission.READ_CONTACTS\n` +
            `Function: Retrieves contacts from the device's contact database`;
    }
