...
export class CommonConstants {
    ...
    static readonly CookieOperation: string[] = [
        context.resourceManager.getStringSync({ "id": 16777225, "type": 10003, params: [], "bundleName": "com.example.webcookie", "moduleName": "entry" }.id),
        context.resourceManager.getStringSync({ "id": 16777230, "type": 10003, params: [], "bundleName": "com.example.webcookie", "moduleName": "entry" }.id),
        context.resourceManager.getStringSync({ "id": 16777222, "type": 10003, params: [], "bundleName": "com.example.webcookie", "moduleName": "entry" }.id),
        context.resourceManager.getStringSync({ "id": 16777233, "type": 10003, params: [], "bundleName": "com.example.webcookie", "moduleName": "entry" }.id)
    ];
}
