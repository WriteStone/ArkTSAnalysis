...
export class ContactsList extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("features/home/src/main/ets/pages/ContactsList.ets(47:5)", "home");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("features/home/src/main/ets/pages/ContactsList.ets(50:7)", "home");
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create({ scroller: this.listScroller });
            List.debugLine("features/home/src/main/ets/pages/ContactsList.ets(51:9)", "home");
        ...
        }, List);
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("features/home/src/main/ets/pages/ContactsList.ets(52:11)", "home");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new ContactsItem(this, { name: HomeConstants.CONTACTS_LIST[0], icon: { "id": 50331710, "type": 20000, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" } }, undefined, elmtId, () => { }, { page: "features/home/src/main/ets/pages/ContactsList.ets", line: 53, col: 13 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {
                                    name: HomeConstants.CONTACTS_LIST[0],
                                    icon: { "id": 50331710, "type": 20000, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" }
                                };
                            };
                            componentCall.paramsGenerator_ = paramsLambda;
                        }
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.height(Adaptive.ContactItemHeight(this.currentBreakpoint));
                ListItem.backgroundColor(Color.White);
                ListItem.debugLine("features/home/src/main/ets/pages/ContactsList.ets(58:11)", "home");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new ContactsItem(this, { name: HomeConstants.CONTACTS_LIST[1], icon: { "id": 50331874, "type": 20000, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" } }, undefined, elmtId, () => { }, { page: "features/home/src/main/ets/pages/ContactsList.ets", line: 59, col: 13 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {
                                    name: HomeConstants.CONTACTS_LIST[1],
                                    icon: { "id": 50331874, "type": 20000, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" }
                                };
                            };
                            componentCall.paramsGenerator_ = paramsLambda;
                        }
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                const item = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ListItem.create(deepRenderFunction, true);
                        ListItem.height(Adaptive.ContactItemHeight(this.currentBreakpoint));
                        ListItem.debugLine("features/home/src/main/ets/pages/ContactsList.ets(65:13)", "home");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            __Common__.padding({ "id": 50331787, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" });
                            __Common__.backgroundColor(this.currentIndex === index ? { "id": 50331880, "type": 10001, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" } : Color.White);
                        }, __Common__);
                        {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                if (isInitialRender) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            AlphabetIndexer.debugLine("features/home/src/main/ets/pages/ContactsList.ets(90:9)", "home");
            ...
            AlphabetIndexer.margin({ right: { "id": 50331769, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" } });
