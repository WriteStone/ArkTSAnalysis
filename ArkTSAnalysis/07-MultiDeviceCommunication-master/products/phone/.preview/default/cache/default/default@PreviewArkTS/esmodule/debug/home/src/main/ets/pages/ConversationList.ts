...
export class ConversationList extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("features/home/src/main/ets/pages/ConversationList.ets(33:5)", "home");
            Flex.height('100%');
            Flex.width('100%');
        }, Flex);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.create();
            List.debugLine("features/home/src/main/ets/pages/ConversationList.ets(37:7)", "home");
            // [Start conversation_list]
            List.padding({
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                const item = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("features/home/src/main/ets/pages/ConversationList.ets(39:11)", "home");
                    };
