...
interface IntroduceText_Params {
    data?: ResourceStr;
    fontSize?: Resource;
    fontColor?: Resource;
    fontWeight?: number;
...
export class IntroduceText extends ViewPU {
    ...
    setInitiallyProvidedValue(params: IntroduceText_Params) {
        if (params.fontSize === undefined) {
            this.__fontSize.set({ "id": 50331697, "type": 10002, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" });
        }
        if (params.fontColor === undefined) {
            this.__fontColor.set({ "id": 50331670, "type": 10001, params: [], "bundleName": "com.example.multdevicecommunication", "moduleName": "phone" });
        }
        if (params.fontWeight === undefined) {
            this.__fontWeight.set(BaseConstants.FONT_WEIGHT_FOUR);
        }
    }
    updateStateVars(params: IntroduceText_Params) {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("common/base/src/main/ets/views/text/IntroduceText.ets(25:5)", "base");
            Text.opacity(0.5);
