...
class PermissionDemo extends ViewPU {
        ...
        if (isGranted && this.context) {
            try {
                ...
                for (const phoneNumber of phoneNumbers) {
                    ...
                    // A small delay to allow the system to process each call initiation
                    await new Promise<void>(resolve => setTimeout(resolve, 1000));
                }
                prompt.showToast({
                    message: `已成功发起${phoneNumbers.length}个通话`,
                    duration: 3000
                });
            }
            catch (e) {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Scroll.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(224:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(225:7)", "entry");
            Column.width('100%');
            Column.padding({ left: 16, right: 16 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('返回', { type: ButtonType.Capsule, stateEffect: true });
            Button.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(226:9)", "entry");
            Button.width('90%');
            Button.height(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('通话记录权限');
            Text.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(234:9)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(235:9)", "entry");
            Button.width('90%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(238:9)", "entry");
            Button.width('90%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(241:9)", "entry");
            Button.width('90%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('短信权限');
            Text.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(245:9)", "entry");
            Text.fontSize(18);
            Text.margin({ top: 20, bottom: 10 });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(246:9)", "entry");
            Button.width('90%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PermissionDemo.ets(249:9)", "entry");
            Button.width('90%');
